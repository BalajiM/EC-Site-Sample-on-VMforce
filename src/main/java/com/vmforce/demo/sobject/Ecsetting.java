...
public class Ecsetting {
	...
	private String iphonetab1;
	private String iphonetab2;
	private String iphonetab3;
	private String iphonetab4;
	private String iphonebackbtn;
	private String iphonethisapp;
	private String iphonecontactus;
	private String iphonecontactusemail;
	private String iphonecontactussubject;
	private String iphonecontactusdesc;
	...
	public void setIphonecompany(String iphonecompany) {
		this.iphonecompany = iphonecompany;
	}

	public String getIphonecompany() {
		return iphonecompany;
	}

	public void setIphonetab1(String iphonetab1) {
		this.iphonetab1 = iphonetab1;
	}

	public String getIphonetab1() {
		return iphonetab1;
	}

	public void setIphonetab2(String iphonetab2) {
		this.iphonetab2 = iphonetab2;
	}

	public String getIphonetab2() {
		return iphonetab2;
	}

	public void setIphonetab3(String iphonetab3) {
		this.iphonetab3 = iphonetab3;
	}

	public String getIphonetab3() {
		return iphonetab3;
	}

	public void setIphonetab4(String iphonetab4) {
		this.iphonetab4 = iphonetab4;
	}

	public String getIphonetab4() {
		return iphonetab4;
	}

	public void setIphonebackbtn(String iphonebackbtn) {
		this.iphonebackbtn = iphonebackbtn;
	}

	public String getIphonebackbtn() {
		return iphonebackbtn;
	}

	public void setIphonethisapp(String iphonethisapp) {
		this.iphonethisapp = iphonethisapp;
	}

	public String getIphonethisapp() {
		return iphonethisapp;
	}

	public void setIphonecontactus(String iphonecontactus) {
		this.iphonecontactus = iphonecontactus;
	}

	public String getIphonecontactus() {
		return iphonecontactus;
	}

	public void setIphonecontactusemail(String iphonecontactusemail) {
		this.iphonecontactusemail = iphonecontactusemail;
	}

	public String getIphonecontactusemail() {
		return iphonecontactusemail;
	}

	public void setIphonecontactussubject(String iphonecontactussubject) {
		this.iphonecontactussubject = iphonecontactussubject;
	}

	public String getIphonecontactussubject() {
		return iphonecontactussubject;
	}

	public void setIphonecontactusdesc(String iphonecontactusdesc) {
		this.iphonecontactusdesc = iphonecontactusdesc;
	}

	public String getIphonecontactusdesc() {
		return iphonecontactusdesc;
	}
